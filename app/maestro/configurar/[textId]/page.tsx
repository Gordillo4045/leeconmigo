...
export default function MaestroConfigurarPage() {
  ...
  if (!textId) {
    return (
      <div className="mx-auto max-w-4xl p-4 space-y-4">
        ...
        <Button asChild variant="outline"><Link href="/maestro/gestion">Volver a Plantillas</Link></Button>
      </div>
    );
  }
    ...
    <div className="mx-auto max-w-6xl px-4 py-6">
      <div className="mb-4 flex items-center gap-3">
        <Button variant="outline" size="sm" asChild>
          <Link href="/maestro/gestion">← Plantillas</Link>
        </Button>
      </div>
